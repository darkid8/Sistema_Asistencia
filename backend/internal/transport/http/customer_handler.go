...
// List returns every registered customer. Only the workshop manager may see
// the customer registry: a technician has no business need for it and it
// carries personal data (document number, phone, email).
