...
// List returns every vehicle with the name of its owner. Restricted to the
// workshop manager for the same reason as the customer registry: it exposes
// data (owner, plate, VIN) a technician does not need to do their job.
